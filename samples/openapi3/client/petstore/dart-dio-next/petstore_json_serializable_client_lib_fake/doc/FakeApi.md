...
try { 
    final response = api.testClientModel(client);
    print(response);
} catch on DioError (e) {
...
final List<String> enumQueryStringArray = ; // List<String> | Query parameter enum test (string array)
...
final List<String> enumFormStringArray = enumFormStringArray_example; // List<String> | Form parameter enum test (string array)
...
final List<String> ioutil = ; // List<String> | 
