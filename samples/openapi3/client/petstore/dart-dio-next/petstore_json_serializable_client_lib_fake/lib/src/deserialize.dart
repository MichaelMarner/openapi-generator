...
import 'package:openapi/src/model/enum_class.dart';
...
final _regMap = RegExp(r'^Map<String,(.*)>$');
  ...
  ReturnType deserialize<ReturnType, BaseType>(dynamic value, String targetType, {bool growable= true}) {
      switch (targetType) {
        ...
        case 'Client':
          return Client.fromJson(value as Map<String, dynamic>) as ReturnType;
        ...
        case 'InlineResponseDefault':
          return InlineResponseDefault.fromJson(value as Map<String, dynamic>) as ReturnType;
        case 'MapTest':
        ...
        default:
          ...
          if (value is List && (match = _regList.firstMatch(targetType)) != null) {
            ...
            return value
              .map<BaseType>((v) => deserialize<BaseType, BaseType>(v, targetType, growable: growable))
          ...
          if (value is Map && (match = _regMap.firstMatch(targetType)) != null) {
            ...
            return Map.fromIterables(
              value.keys,
              value.values.map((v) => deserialize<BaseType, BaseType>(v, targetType, growable: growable)),
            ) as ReturnType;
          }
          break;
    } 
